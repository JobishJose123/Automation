...
public class CommonObjects extends Init {
	...
	// @FindBy(xpath =
	// "//div//data-table-column-filter-dialog//paper-icon-button//iron-icon[@id
	// ='icon']")
...
//		private WebElement ;
	...
	@FindBy(xpath = "(//label[contains(.,'Data Type')]//following::input[1])[2]")
	private WebElement streamingAttrDataTypeInput1;
	...
	@FindBy(xpath = "(//paper-item[contains(.,'DOUBLE')])[2]")
	private WebElement dataTypeDouble1;
	@FindBy(xpath = "//paper-button[contains(.,'Save')]")
...
//			private WebElement ;
	...
	public void clickEditIcon() throws InterruptedException {
		jswait.loadClick(
				"(//paper-item[@class='predefined-targets style-scope x-scope paper-item-1'][contains(text(),Edit)])[1]");
	}
	...
	public void filterBCName(String sheetname, String name) throws InterruptedException {
		...
		if (sheetname.contains("one-offBC") || sheetname.contains("TriggerOneoff")) {
			...
			clickTriggarableFilterApplyButton();
				...
				|| sheetname.contentEquals("recurringBCEdit") || sheetname.contentEquals("recurringBCForAbort")
				|| sheetname.contentEquals("recurringBCForPause")) {
	...
	public void clickBCOptionsIcon(String sheet) throws InterruptedException {
		...
		} else if (sheet.contentEquals("recurringBC") || sheet.contentEquals("recurrBCDaily")
				|| sheet.contentEquals("recurringBCEdit") || sheet.contentEquals("recurringBCForAbort")
				|| sheet.contentEquals("recurringBCForPause")) {
...
//Thread.sleep(10000);
		...
		} else if (bctype.equalsIgnoreCase("seeding") || bctype.equalsIgnoreCase("seedingoneoff")
				|| bctype.equalsIgnoreCase("seedingRecurring")) {
			clickSeedingFilterIcon();
			Thread.sleep(2000);
	...
	public void createStreamingAttr(String attrName, String description, String value1, String value2)
			throws Exception {
		...
		jswait.loadClick("//paper-icon-button[@id='add_stream_attr']//iron-icon[@id='icon']");
		jswait.loadClick(streamingAttrDataTypeInput1);
		jswait.loadClick(dataTypeDouble1);
		jswait.loadSendKeys(streamingAttrValue2, value2);
		jswait.loadClick(streamingAttrSave);
	}

	public void createStreamingAttr(String attrName, String description, String value1, String value2, String route)
			throws Exception {
		jswait.loadClick(streamingAttrCreatebtn);
		jswait.loadSendKeys(streamingAttrName, attrName);
		jswait.loadSendKeys(streamingAttrDesp, description);
	...
	public void createHttpConnector(String httpSheet, String httpConnectorName, String webhookUrl)
