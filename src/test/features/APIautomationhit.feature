...
Then create Program with API hit with name "swapna program"  offer cataloge "SeleniumCatalog3735" and touchpoint channel type "API" and touchpointname "defaultapiTPGR"
...
Then create a rule with name "Recharge offer rule" for program with name "new API selenium auto"  offer name "rechSMSOffer2815" and list "selenium_list" and product name "singleProd4694" and offertype "Recharge"
Then create a rule with name "Stv offer rule" for program with name "new API selenium auto"  offer name "seedWAPOffer6598" and list "selenium_list" and product name "singleProd4694" and offertype "STV"
...
Given login
#Then create productclass with API hit with name "seleniumapihitclass"  description "testdata"
