...
@NDX-5511, @NDX-5518, @NDX-5527, @NDX-5528, @NDX-8011 @ndkcamptest @initBrowser @closeBrowser
Scenario Outline: Verify Editing campaign with target condition <Condition> 
	...
	Examples: 
		...
		@NDX-5496, @NDX-5498 @initBrowser @closeBrowser
		...
		@NDX-5554 @initBrowser @closeBrowser
		...
		@NDX-5558 @initBrowser @closeBrowser 
		...
		@NDX-5550 @initBrowser @closeBrowser 
		...
		@NDX-5530, @NDX-5524, @NDX-5515, @NDX-5514, @NDX-5513, @NDX-5504 	@initBrowser 
