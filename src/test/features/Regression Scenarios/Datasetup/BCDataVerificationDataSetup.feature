...
#	Then navigate to landing page 
#		
#		@Create9999989 @initBrowser @closeBrowswer 
...
#		
#				
##@activateInventoryBCsrewardBcs @initBrowser 
##Scenario: Activating the bcs 
##	Given login 
##	Then navigate to precision marketer 
##	Then activate and verify the broadcast from workbook "parallelRunBC" and sheet "rewardBcs"
#					
#					
