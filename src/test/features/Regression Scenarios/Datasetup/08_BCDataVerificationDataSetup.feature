...
@NDX-CreateProductCCBC @NDX-CreateProductCCB @initBrowser @closeBrowser 
Scenario: 
	Verify BC targeting using all types of target conditions with one time BC 
	Given login 
...
@NDX-CreateAllOffersForBC9 @initBrowser 
...
@NDX-CreateCampaignforblackout @initBrowser 
...
@NDX-BlckoutOneoffbC @initBrowser 
...
@NDX-CreateCampaigncategoryBC @initBrowser 
Scenario: Verify BC targeting using all types of target conditions with one time BC 
	Given login 
	Then navigate to configuration management 
	Then naviagte to product classes 
...
@CreateConversionAndFulfilmentBCs @initBrowser 
...
@CreateUsageConversionAndFulfilmentBCs @initBrowser  
Scenario Outline: Create all type of bcs with <bcSheet> with <offerSheet> and <condition>, <rewardTypeRule> 
	Given login 
	Then navigate to precision marketer 
	Then navigate to offer management 
